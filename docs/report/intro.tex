...
C'est un jeu qui se joue sur un plateau de 25x20. Contrairement à Desert Fox le plateau est contient des cases carrées. La ressemblance avec Desert Fox est la formation d'unité (infanterie, cavalerie, artillerie).
