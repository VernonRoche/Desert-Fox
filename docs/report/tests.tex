...
Nous nous sommes donc fixés d'au moins atteindre ce pourcentage. Un fichier fausse notre {\tt coverage}, en effet nous ne testons pas main/GameManager/StateMachine/Command.ts car nous vérifions déjà dans le frontend que les commandes soumises aient les bons arguments.