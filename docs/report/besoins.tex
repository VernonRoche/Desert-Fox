...
\begin{center}
    ...
    \begin{tabular}[h]{|m{14cm}|m{2cm}|}
        ...
        • Appliquer un bonus de mouvement dépendant du terrain d'un hexagone. C'est plus facile de se déplacer sur une plaine plutôt qu'à travers des montagnes                                                                                                                                                & \FAIT         \\
