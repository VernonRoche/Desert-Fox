...
\begin{center}
    ...
    \begin{tabular}[h]{|m{14cm}|m{2cm}|}
        ...
        \hspace*{10mm} \- Amasser les dégâts et puis causer des dégâts aux unités adverses.\newline Les dégâts sont distribués parmis toutes les unités d'un groupe de morale. & \FAIT          \\
        ...
        \hspace*{10mm} \- Lancer un dé pour faire le test de morale des unités qui reste. Si le test échoue, alors l'unité est \"disrupted\".    & \FAIT          \\                                                                                                                                                 & ?          \\
