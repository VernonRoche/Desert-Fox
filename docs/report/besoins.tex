...
\begin{center}
    ...
    \begin{tabular}[h]{|m{14cm}|m{2cm}|}
        ...
        • Implémenter le système similaire à des points de vie (voir partie {\tt Depletion} des règles)                                                           & \FAIT      \\
        ...
        \begin{itemize}
            ...
            \item Après la phase de {\tt Supply Attrition}, il y a un échec sur le test d'usure (attrition)
        \end{itemize}
                                                                                                                                                                  & \FAIT      \\
        \hline
    \end{tabular}
